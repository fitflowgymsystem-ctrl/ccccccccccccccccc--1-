    ...
    return (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-[1100] flex items-center justify-center p-4 cursor-pointer" onClick={onCancel}>
            ...
            >
                ...
                <h3 className="font-black text-xl dark:text-white mb-2 uppercase tracking-tighter">
                ...
                <div className="flex gap-3">
                    <button onClick={onCancel} className="flex-1 py-3 bg-gray-100 dark:bg-slate-700 text-gray-500 dark:text-gray-300 rounded-xl font-black text-sm uppercase tracking-widest active:scale-95">
                        {lang === 'ar' ? 'إلغاء' : 'Cancel'}
                    </button>
                    <button onClick={onConfirm} className="flex-1 py-3 bg-red-600 text-white rounded-xl font-black shadow-lg text-sm uppercase tracking-widest active:scale-95 hover:bg-red-700 transition-all">
