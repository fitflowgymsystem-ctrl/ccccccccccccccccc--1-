                ...
                <form onSubmit={handleSubmit} className="p-4 space-y-4">
                    <div className="space-y-1">
                        ...
                        <input
                            ...
                            className="w-full px-3 py-2 bg-gray-50 dark:bg-slate-950 border dark:border-slate-700 text-gray-900 dark:text-white rounded-xl text-xs font-bold outline-none focus:ring-1 focus:ring-blue-500"
                        />
                    </div>

                    <div className="grid grid-cols-2 gap-3">
                        <div className="space-y-1">
                            <label className="block text-[8px] font-black text-gray-400 uppercase tracking-widest ps-1 flex items-center gap-1"><Globe size={8} /> IP Address</label>
                            <input
                        ...
                        <div className="space-y-1">
                            <label className="block text-[8px] font-black text-gray-400 uppercase tracking-widest ps-1 flex items-center gap-1"><Hash size={8} /> Port</label>
                            <input
                    ...
                    <div className="space-y-1">
                        ...
                        <select
                            ...
                            className="w-full px-3 py-2 bg-gray-50 dark:bg-slate-950 border dark:border-slate-700 rounded-xl text-[10px] font-black uppercase outline-none dark:text-white"
                        >
                    ...
                    <div className="pt-2 flex gap-2">
                        <button type="button" onClick={onClose} className="flex-1 py-2.5 bg-gray-100 dark:bg-slate-700 text-[10px] font-black uppercase text-gray-400 rounded-xl">Cancel</button>
                        <button type="submit" className="flex-[2] py-2.5 bg-blue-600 text-white rounded-xl font-black text-[10px] uppercase shadow-lg shadow-blue-600/20 flex items-center justify-center gap-2 active:scale-95 transition-all">
                            <Save size={14} /> {t.save}
                        </button>
                    </div>
                </form>
